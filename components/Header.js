...
<div className=' text-gray-400 font-bold  text-lg truncate   my-5 ' >Debes usar <span className='text-white'>NextJS</span> y <span  className='text-white'>Tailwind CSS</span> . Cada sección de la <br/> página debe ser un componente individual. Usa el módulo <br/>
...
<Image alt='Logo' priority={true} className=' lg:w-[27rem] h-auto z-30 hover:scale-105 transition-all' src={imagen} />
<Image alt='Logo de fondo' priority={true} className=' z-20   absolute w-4/5 h-3/4  left-[35%] ' src={imagen2} />
<Image alt='Logo' priority={true} className='h-10 w-auto ml-36 top-[23.5rem] absolute   ' src={imagen3}  />
</section>
        </div>
